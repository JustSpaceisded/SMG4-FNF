...
class ClientPrefs {
	//TO DO: Redo ClientPrefs in a way that isn't too stupid //Sorry Mario, Not For This Mod. Unless... -Generalisk
	...
	public static var hideTime:Bool = true; //I Find This A Nuisence While Playtesting. And Is Only Here By Poplar Developer Demand -Generalisk
