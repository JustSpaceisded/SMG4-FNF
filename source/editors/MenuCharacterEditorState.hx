...
class MenuCharacterEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		DiscordClient.changePresence("Menu Character Editor", "Editting: " + characterFile.image, characterFile.image);
		#end
		...
		tipText.setFormat(Paths.font("smg.ttf"), 16, FlxColor.WHITE, CENTER);
