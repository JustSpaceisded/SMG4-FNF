...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		missingFileText.setFormat(Paths.font("smg.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("smg.ttf");
	...
	function reloadWeekThing() {
		...
		DiscordClient.changePresence("Week Editor", "Editting: " + weekFileName, "title-card");
		#end
	}
