...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.frames = Paths.getSparrowAtlas('TitleCardBop');
		logoBl.antialiasing = ClientPrefs.globalAntialiasing;
		logoBl.animation.addByPrefix('bump', 'title', 24);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Cometflamer'], -90);
					addMoreText('Yume Potato', -90);
					addMoreText('Unknown634', -90);
					addMoreText('Generalisk', -90);
					addMoreText('Gazozoz', -90);
					addMoreText('And More', -90);
				case 3:
					addMoreText('Presents', -90);
				case 4:
					deleteCoolText();
				case 5:
